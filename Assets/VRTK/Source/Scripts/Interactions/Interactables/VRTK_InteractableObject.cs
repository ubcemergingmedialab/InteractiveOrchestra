...
namespace VRTK
{
    ...
    /// <param name="e">
    ///     <see cref="InteractableObjectEventArgs" />
    /// </param>
    ...
    /// <remarks>
    ///     **Required Components:**
    ///     * `Collider` - A Unity Collider to determine when an interaction has occured. Can be a compound collider set in
    ///     child GameObjects.
    ///     **Optional Components:**
    ///     * `Rigidbody` - A Unity Rigidbody to allow the GameObject to be affected by the Unity Physics System (not required
    ///     for Climbable Grab Attach Types).
    ///     * `VRTK_BaseGrabAttach` - A Grab Attach mechanic for determining how the Interactable Object is grabbed by the
    ///     primary interacting object.
    ///     * `VRTK_BaseGrabAction` - A Grab Action mechanic for determining how to manipulate the Interactable Object when
    ///     grabbed by the secondary interacting object.
    ///     **Script Usage:**
    ///     * Place the `VRTK_InteractableObject` script onto the GameObject that is to be interactable.
    ///     * Alternatively, select the GameObject and use the `Window -> VRTK -> Setup Interactable Object` panel to set up
    ///     quickly.
    ...
    ///     * If the above is not provided, then the first active Base Highlighter found on the Interactable Object GameObject
    ///     will be used.
    ///     * If the above is not found, then a Material Color Swap Highlighter will be created on the Interactable Object
    ///     GameObject at runtime.
    ///     **Script Dependencies:**
    ///     * Interactions
    ///     * To near touch an Interactable Object the Interact NearTouch script is required on a controller Script Alias
    ///     GameObject.
    ///     * To touch an Interactable Object the Interact NearTouch script is required on a controller Script Alias
    ///     GameObject.
    ...
    ///     * Highlighting
    ///     * To highlight an Interactable Object on a given interaction then a valid Interact Object Highlighter script must
    ///     be associated with the Interactable Object.
    ///     * Appearance
    ///     * To affect the appearance of an Interactable Object then a valid Interact Object Appearance script must be
    ///     associated with the Interactable Object.
    /// </remarks>
    /// <example>
    ///     `VRTK/Examples/005_Controller_BasicObjectGrabbing` uses the `VRTK_InteractTouch` and `VRTK_InteractGrab` scripts on
    ///     the controllers to show how an interactable object can be grabbed and snapped to the controller and thrown around
    ///     the game world.
    ///     `VRTK/Examples/013_Controller_UsingAndGrabbingMultipleObjects` shows multiple objects that can be grabbed by
    ///     holding the buttons or grabbed by toggling the button click and also has objects that can have their Using state
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="grabbedBy">
        ///     An optional GameObject to check if the Interactable Object is grabbed by that specific
        ///     GameObject. Defaults to `null`
        /// </param>
        ...
        /// </summary>
        /// <param name="usedBy">
        ///     An optional GameObject to check if the Interactable Object is used by that specific GameObject.
        ///     Defaults to `null`
        /// </param>
        ...
        /// </summary>
        /// <param name="currentNearTouchingObject">
        ///     The interacting object that is currently nearly touching this Interactable
        ///     Object.
        /// </param>
        ...
        /// </summary>
        /// <param name="previousNearTouchingObject">
        ///     The interacting object that was previously nearly touching this Interactable
        ///     Object.
        /// </param>
        ...
        // [EML Change]
        // This part conflicts with the material changing in our ButtonState so we comment it out. This is also an obsolete feature that won't exist in the future. 
        ...
        //        /// </summary>
        //        /// <param name="toggle">
        //        ///     The state to determine whether to activate or deactivate the highlight. `true` will enable the
        //        ///     highlight and `false` will remove the highlight.
        //        /// </param>
        ...
        /// <summary>
        ///     The PauseCollisions method temporarily pauses all collisions on the Interactable Object at grab time by removing
        ///     the Interactable Object's Rigidbody's ability to detect collisions.
        /// </summary>
        ...
        /// <summary>
        ///     The ZeroVelocity method resets the velocity and angular velocity to zero on the Rigidbody attached to the
        ///     Interactable Object.
        /// </summary>
        ...
        /// <summary>
        ///     The GetNearTouchingObjects method is used to return the collecetion of valid GameObjects that are currently nearly
        ///     touching this Interactable Object.
        /// </summary>
        ...
        /// <summary>
        ///     The GetTouchingObjects method is used to return the collecetion of valid GameObjects that are currently touching
        ...
        /// <summary>
        ///     The GetSecondaryGrabbingObject method is used to return the GameObject that is currently being used to influence
        ///     this Interactable Object whilst it is being grabbed by a secondary influencing.
        /// </summary>
        ...
        /// <summary>
        ///     The GetUsingScript method is used to return the Interact Use component that is currently using this Interactable
        ///     Object.
        /// </summary>
        ...
        /// <summary>
        ///     The IsValidInteractableController method is used to check to see if a controller is allowed to perform an
        ///     interaction with this Interactable Object as sometimes controllers are prohibited from grabbing or using an
        ///     Interactable Object depedning on the use case.
        /// </summary>
        ...
        /// <summary>
        ///     The ForceStopInteracting method forces the Interactable Object to no longer be interacted with and will cause an
        ///     interacting object to drop the Interactable Object and stop touching it.
        /// </summary>
        ...
        /// <summary>
        ///     The ForceStopSecondaryGrabInteraction method forces the Interactable Object to no longer be influenced by the
        ///     second controller grabbing it.
        /// </summary>
        ...
        /// <summary>
        ///     The RegisterTeleporters method is used to find all GameObjects that have a teleporter script and register the
        ///     Interactable Object on the `OnTeleported` event.
        /// </summary>
        ...
        /// <summary>
        ///     The UnregisterTeleporters method is used to unregister all teleporter events that are active on this Interactable
        ///     Object.
        /// </summary>
        ...
        /// <summary>
        ///     The ToggleSnapDropZone method is used to set the state of whether the Interactable Object is in a Snap Drop Zone or
        ///     not.
        /// </summary>
        ...
        ///     denotes the Interactable Object is snapped to the Snap Drop Zone and `false` denotes it has been removed from the
        ///     Snap Drop Zone.
        /// </param>
        ...
        /// </summary>
        /// <returns>
        ///     Returns `true` if the Interactable Object is currently snapped in a Snap Drop Zone, returns `false` if it is
        ///     not.
        /// </returns>
        ...
        /// <summary>
        ///     The SetSnapDropZoneHover method sets whether the Interactable Object is currently being hovered over a valid Snap
        ///     Drop Zone.
        /// </summary>
        ...
        /// <summary>
        ///     The IsHoveredOverSnapDropZone method returns whether the Interactable Object is currently hovering over a Snap Drop
        ///     Zone.
        /// </summary>
        ...
        /// </summary>
        /// <returns>
        ///     Returns `true` if the Interactable Object can currently be dropped, returns `false` if it is not currently
        ///     possible to drop.
        /// </returns>
        ...
        /// <summary>
        ///     The IsSwappable method returns whether the Interactable Object can be grabbed with one interacting object and then
        ///     swapped to another interacting object by grabbing with the secondary grab action.
        /// </summary>
        /// <returns>
        ///     Returns `true` if the Interactable Object can be grabbed by a secondary interacting object whilst already
        ///     being grabbed and the Interactable Object will swap controllers. Returns `false` if the Interactable Object cannot
        ///     be swapped.
        /// </returns>
        ...
        /// <summary>
        ///     The PerformSecondaryAction method returns whether the Interactable Object has a Secondary Grab Action that can be
        ///     performed when grabbing the object with a secondary interacting object.
        /// </summary>
        /// <returns>
        ///     Returns `true` if the Interactable Object has a Secondary Grab Action, returns `false` if it has no Secondary
        ///     Grab Action or is swappable.
        /// </returns>
        ...
        /// <summary>
        ///     The UnsubscribeFromInteractionEvent method unsubscribes a previous event subscription for the given Interaction
        ///     Type.
        /// </summary>
        ...
        /// <summary>
        ///     The GetPrimaryAttachPoint returns the Transform that determines where the primary grabbing object is grabbing the
        ///     Interactable Object at.
        /// </summary>
        ...
        /// <summary>
        ///     The GetSecondaryAttachPoint returns the Transform that determines where the secondary grabbing object is grabbing
        ///     the Interactable Object at.
        /// </summary>
